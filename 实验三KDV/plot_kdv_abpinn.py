...
data_load_path = os.path.join(save_dir, "kdv_abpinn_results.npz")
...
# 保存图像
save_img_path = os.path.join(save_dir, "Baseline2_AB_Only.png")
plt.savefig(save_img_path, dpi=200)
print(f"🎉 Baseline 2 图片已成功保存至: {save_img_path}")
plt.show()